...
const Component = ({setOrderType, setServiceName}) => {
    ...
    <FadeInSection delay={0}>
      <div className={style.first}>
        ...
        <button className={style.button} 
          onClick={() => {
            setOrderType('searchCar')
            setServiceName('пошук автомобіля')
      ...
      <div className={style.first}>
        ...
        <button className={style.button} onClick={() => {
          setOrderType('fullCheck')
          setServiceName('повна перевірка')
          window.location.href = '#order'
          }}>
          Замовити послугу
        </button>
      ...
      <div className={style.first}>
        ...
        {/* Button */}
        <button className={style.button} onClick={() => {
          setOrderType('suprovidUgodu') 
          setServiceName('супровід угоди')
          window.location.href = '#order'
          }}>
          Замовити послугу
        </button>
      ...
      <div className={style.first}>
        ...
        {/* Button */}
        <button className={style.button}  onClick={() => {
          setOrderType('technicalCheck') 
          setServiceName('технічна експертиза')
          window.location.href = '#order'
          }}>
          Замовити послугу
        </button>
      ...
      <div className={style.icon}>
        ...
        {/* Button */}
        <button className={style.button} onClick={() => {
          setOrderType('creditHelp') 
          setServiceName('допомога з кредитом')
          window.location.href = '#order'
          }}>
          Замовити послугу
        </button>
